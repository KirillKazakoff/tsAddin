    ...
    const cells = {
        ...
        cfr: {
            common: [
                ...
                {
                    cell: 'Договор_Меркурий',
                    value: '',
                    height: 13,
                },
                {
                    cell: 'Договор_момент_приемки',
                    value: '',
                    height: 27,
                },
            ],
            default: [
                ...
                {
                    cell: 'Договор_приемка_товара_ВСД',
        ...
        exw: [
            {
                cell: 'Договор_передача_EXW',
                value: `4.2. Товар передается Покупателю с холодильника в порту Владивосток после внесения предоплаты. Грузовые работы с холодильника в порту ${r.port.code} – за счет Покупателя ? ИЛИ ? Поставщика.`,
                height: 30,
            },
            {
                cell: 'Договор_приемка_EXW',
            ...
            {
                cell: 'Договор_момент_приемки_EXW',
